...
These recurrences are implementable in $O(N)$, but I won't go into detail, as the target audience of this article is supposed to be able to solve this on its own.
